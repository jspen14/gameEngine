...
export default{
  ...
  methods: {
    registerUser: function() {
      this.$store.dispatch('register', {name: this.name, role: this.role, password: this.password}).catch(alert=true);
    },
      login: function(){
    this.$store.dispatch('login', {name: this.name, password:this.password}).catch(alert=true);
  },
